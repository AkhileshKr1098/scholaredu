...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    <tr>
        <td colspan="2" style="display: flex; justify-content: center; text-align: center; width: 100%;">
            <img src="https://scholaredu.in/images/logo3%20copy.jpg" alt="Header Image" style="width: 100%;">
        </td>
    </tr>
    <tr>
